<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:60:"E:\phpStudy\WWW\kyw/application/user\view\index_comment.html";i:1548560568;s:57:"E:\phpStudy\WWW\kyw\application\user\view\index_base.html";i:1548817152;s:59:"E:\phpStudy\WWW\kyw\application\user\view\index_header.html";i:1548836794;s:59:"E:\phpStudy\WWW\kyw\application\user\view\index_footer.html";i:1548815724;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<div class="main fly-user-main layui-clear">
    <ul class="layui-nav layui-nav-tree layui-inline user-set"  lay-filter="user"  >
        ...
        <li class="layui-nav-item  tab-this">
            <a href="<?php echo url('index/comment'); ?>" style="color: white !important;">
                &nbsp;<i class="iconfont">&#xe644;</i>
                我的回复
            </a>
        </li>
  ...
  <div class="fly-panel fly-panel-user" pad20>
    <div class="layui-tab layui-tab-brief">
      <ul class="layui-tab-title">
		...
		<li class="layui-this"><a href="<?php echo url('user/index/comment'); ?>">我的评论</a></li>
      </ul>
      <div class="layui-tab-content" style="padding: 20px 0;">
		  ...
		  <ul class="home-jieda">
			...
			<li>
			  ...
			  在<a href="<?php echo url('bbs/index/thread',array('id'=>$vo['fid'])); ?>" target="_blank"><?php echo $vo['title']; ?></a>中回答 <a class="mine-edit" href="<?php echo url('bbs/comment/edit',array('id'=>$vo['id'])); ?>">编辑</a>
			  </p>
