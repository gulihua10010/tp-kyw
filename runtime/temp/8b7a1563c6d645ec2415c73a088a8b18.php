<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:59:"E:\phpStudy\WWW\kyw/application/admin\view\school_edit.html";i:1548309400;s:52:"E:\phpStudy\WWW\kyw\application\admin\view\base.html";i:1548150336;}*/ ?>
<!DOCTYPE html>
<html>
            ...
            <form class="layui-form form-container" id="layui-form"
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="name" required lay-verify="required" value="<?php echo $school['name']; ?>"
                ...
                <div class="layui-form-item" style="width: 500px">
                    ...
                    <div class="layui-input-block">
                        <select id="proid">
                            ...
                            <option value="<?php echo $vo['id']; ?>"  <?php if($vo['id'] == $school['proid']): ?>selected<?php endif; ?>><?php echo $vo['name']; ?>
                            </option>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="code" required lay-verify="required" placeholder="必填内容"
                               autocomplete="off" class="layui-input" value="<?php echo $school['code']; ?>">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">学校邮箱</label>
                    <div class="layui-input-block">
                        <input type="text" name="email" required lay-verify="required" placeholder="必填内容" value="<?php echo $school['email']; ?>"
                               autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="address" required lay-verify="required" placeholder="必填内容" value="<?php echo $school['address']; ?>"
                               autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="tel" required lay-verify="required" placeholder="必填内容" value="<?php echo $school['tel']; ?>"
                               autocomplete="off" class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="website" required lay-verify="required" placeholder="必填内容" value="<?php echo $school['website']; ?>"
                               autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        ...
                        <input type="text" name="pic" class="layui-input" value="<?php echo $school['pic']; ?>"
                               style="position: absolute;left: 111px;top: 0px;width: 500px;" lay-verify="required">
                    </div>
                </div>
                <div class="layui-form-item" id="pre-pic"  >
                    <label class="layui-form-label">图片预览</label>
                    <img id="uploaded-pic" width="700px"  src="/kyw<?php echo $school['pic']; ?>" >
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        ...
                        <input type="text" name="badge" class="layui-input" value="<?php echo $school['badge']; ?>"
                               style="position: absolute;left: 111px;top: 0px;width: 500px;" lay-verify="required">
                    </div>
                </div>
                <div class="layui-form-item" id="pre-badge"  >
                    <label class="layui-form-label">图片预览</label>
                    <img id="uploaded-badge"  width="150px"   src="/kyw<?php echo $school['badge']; ?>" >
                </div>
                ...
                <div class="layui-form-item xs-bolck"  >
                    ...
                    <div class="layui-input-block">
                        <ul>
                            <?php if(is_array($m) || $m instanceof \think\Collection || $m instanceof \think\Paginator): $i = 0; $__LIST__ = $m;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            <li> <span>专业:<?php echo $vo['mname']; ?> &nbsp;  &nbsp;所在院系:<?php echo $vo['colllege']; ?> </span></li>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </ul>
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <textarea id="info" name="info"><?php echo $school['info']; ?></textarea>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">招生简章</label>
                    <div class="layui-input-block">
                        <textarea id="rule" name="rule"><?php echo $school['rule']; ?></textarea>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">分数线</label>
                    <div class="layui-input-block">
                        <textarea id="grade" name="grade"><?php echo $school['grade']; ?></textarea>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">复试信息</label>
                    <div class="layui-input-block">
                        <textarea id="fushi" name="fushi"><?php echo $school['fushi']; ?></textarea>
                    </div>
                </div>
    ...
    layui.use(['layer', 'form', 'element', 'upload'], function () {
        ...
        $('#glzy').click(function () {
            var index = layer.open({
                ...
                area: ['820px', '500px'], //宽高
                content:  "<?php echo url('admin/school/magor'); ?>?sid=<?php echo $school['id']; ?>" ,
                success:function(){
...
var  types,props,belongs;
        var propv="<?php echo $school['prop']; ?>";
        var typev="<?php echo $school['type']; ?>";
        var belongv="<?php echo $school['belong']; ?>";
        if (propv!=''){
            props=propv.split(',');
        } else {
            props=new Array();
            ...
            if (text0.trim() == '' ||text1.trim() == ''||text2.trim() == ''||text3.trim() == ''  || prop.length == 0 || type.length == 0 || belong.length == 0) {
                ...
                var formdata = {
                    'data': JSON.stringify({
                        ...
                        , 'id':'<?php echo $school['id']; ?>'
                    })
                }
                console.log($('#proid').val())
                ajaxform(formdata, " <?php echo url('admin/school/update'); ?> ", $, function () {
