<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"E:\phpStudy\WWW\kyw/application/admin\view\resource_edit.html";i:1548509808;s:52:"E:\phpStudy\WWW\kyw\application\admin\view\base.html";i:1548150336;}*/ ?>
<!DOCTYPE html>
<html>
            ...
            <form class="layui-form form-container"     id="layui-form"
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="name" required lay-verify="required" placeholder="必填内容" value="<?php echo $res['name']; ?>"
                ...
                <div class="layui-form-item" style="width: 300px">
                    ...
                    <div class="layui-input-block">
                        <select name="tid" id="tid">
                            ...
                            <option value="<?php echo $vo['id']; ?>" <?php if($vo['id'] ==  $res['tid']): ?>select<?php endif; ?>><?php if($vo['level'] != '1'): ?>|<?php for($i=1;$i<$vo['level'];$i++){echo ' --';} endif; ?><?php echo $vo['name']; ?>
                            </option>
                ...
                <div class="layui-form-item" style="width: 300px">
                    ...
                    <div class="layui-input-block">
                        <input type="number" name="point"   placeholder="请填写整数" autocomplete="off" value="<?php echo $res['point']; ?>"
                               class="layui-input">
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        ...
                        <input type="text" name="data" class="layui-input" value="<?php echo $res['data']; ?>"
               ...
               <!--S-->
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="keywords" placeholder="关键词请用|隔开" autocomplete="off" value="<?php echo $res['keywords']; ?>"
                               class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-form-item layui-form-text">
                    ...
                    <div class="layui-input-block">
                        <textarea name="des" placeholder="请输入内容" class="layui-textarea"><?php echo $res['desc']; ?></textarea>
                    </div>
                </div>
...
//resourcw rescourcw
        form.on('submit', function(data){
            ...
            ajaxform(formdata," <?php echo url('admin/resource/update'); ?> ",$,function () {
