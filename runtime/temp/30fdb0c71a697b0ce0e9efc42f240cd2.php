<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"E:\phpStudy\WWW\kyw/application/admin\view\article_index.html";i:1548846004;s:52:"E:\phpStudy\WWW\kyw\application\admin\view\base.html";i:1548150336;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <div class="layui-form form-container layui-tab-content">
        ...
        <div class="layui-tab-item layui-show">
            <div class="layui-box-searchber">
                <a href="<?php echo url('admin/Article/add'); ?>" class="layui-btn layui-btn-small">
                    <i class="layui-icon">&#xe608;</i>添加文章</a>
                <form class=" layui-form-pane" action="<?php echo url('admin/Article/index'); ?>" method="get">
                    <div class="layui-inline">
                        <label class="layui-form-label">关键词</label>
                        <div class="layui-input-inline">
                            <input type="text" name="keyword" value="<?php echo session('articlekeyword'); ?>" placeholder="请输入关键词"
                                   class="layui-input">
                        </div>
                    </div>
                    <div class="layui-inline">
            ...
            <table class="layui-table admin-table">
                ...
                <tr>
                    ...
                    <td style="padding-left: 20px;"><a target="_blank"
                                                       href="<?php echo routerurl('index/article/detail',array('id'=>$vo['id'])); ?>  "><?php echo $vo['title']; ?></a>
                    </td>
                    ...
                    <td align="center"><a target="_blank"  ><?php echo $vo['infoname']; ?></a>
                    </td>
                    <td align="center"><?php echo date("Y-m-d",$vo['time']); ?></td>
                    <td align="center"><a class="layui-btn layui-btn-normal layui-btn-mini"
                                          href="<?php echo url('Article/edit',array('id'=>$vo['id'])); ?>">修改</a>
                        <a class="elementdel layui-btn layui-btn-danger layui-btn-mini" href="javascript:;"
                           data-id="<?php echo $vo['id']; ?>" data-url="<?php echo url('admin/Article/delete',array('id'=>$vo['id'])); ?>" title="删除">删除</a>
                    </td>
                </tr>
        ...
        <div class="layui-tab-item">
            <div class="layui-box-searchber">
                <a href="<?php echo url('admin/Info/add'); ?>" class="layui-btn layui-btn-small">
            ...
            <table class="layui-table admin-table">
                ...
                <tr>
                    ...
                    <td align="center"><?php echo date("Y-m-d",$vo['time']); ?></td>
                    <td align="center"><a class="layui-btn layui-btn-normal layui-btn-mini"
                                          href="<?php echo url('Info/edit',array('id'=>$vo['id'])); ?>">修改</a>
                        <a class="elementdel layui-btn layui-btn-danger layui-btn-mini" href="javascript:;"
                           data-id="<?php echo $vo['id']; ?>" data-url="<?php echo url('admin/Info/delete',array('id'=>$vo['id'])); ?>"
                           title="删除">删除</a>
                    </td>
                </tr>
                <?php endforeach; endif; else: echo "" ;endif; ?>
...
<script>
    layui.use('form',function(){
        ...
        form.on('switch(switchopen)', function (data) {
            ...
            var url = "<?php echo url('admin/article/toggle'); ?>?id=" + data.value + '&status=' + status + '&name=show';
            console.log(url)
        ...
        form.on('switch(switchchoice)', function (data) {
            ...
            var url = "<?php echo url('admin/article/toggle'); ?>?id=" + data.value + '&status=' + status + '&name=choice';
