<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:58:"E:\phpStudy\WWW\kyw/application/bbs\view\index_choice.html";i:1547377358;s:56:"E:\phpStudy\WWW\kyw\application\bbs\view\index_base.html";i:1548764192;s:58:"E:\phpStudy\WWW\kyw\application\bbs\view\index_header.html";i:1548764870;s:56:"E:\phpStudy\WWW\kyw\application\bbs\view\index_menu.html";i:1547377358;s:57:"E:\phpStudy\WWW\kyw\application\bbs\view\index_right.html";i:1547377358;s:58:"E:\phpStudy\WWW\kyw\application\bbs\view\index_footer.html";i:1547380684;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
        ...
        <title>精选帖子|<?php echo $site_config['site_title']; ?>|<?php echo $site_config['seo_title']; ?></title>
...
<div class="header">
  ...
  <?php if(\think\Session::get('userid') != ''): ?>
    ...
    <?php else: ?>
        <!-- 未登入状态 -->
        <a class="unlogin"  onclick="showLogin('<?php echo $lgyzm; ?>');" ><i  style=" font-size: 26px;" class="iconfont  ">&#xe678;</i></a>
        <span  class="unlogin-btn" style="cursor: pointer">
          <a onclick="showLogin('<?php echo $lgyzm; ?>');" style="color:#fff;">登录</a><a onclick="showReg();"  style="color:#fff;">注册</a></span>
        <?php endif; ?>
    </div>
  </div>
</div>
		...
		<li class="fly-list-li">
         <a href="<?php echo url('user/index/home',array('id'=>$vo['userid'])); ?>" class="fly-list-avatar">
          ...
          <p>
            ...
            <span><a href="<?php echo url('index/view',array('id'=>$vo['cid'])); ?>"><?php echo $vo['name']; ?></a></span>
