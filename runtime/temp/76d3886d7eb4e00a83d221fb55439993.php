<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:56:"E:\phpStudy\WWW\kyw/application/index\view\user_reg.html";i:1546766678;s:58:"E:\phpStudy\WWW\kyw\application\index\view\index_base.html";i:1546587990;s:60:"E:\phpStudy\WWW\kyw\application\index\view\index_header.html";i:1546789414;s:60:"E:\phpStudy\WWW\kyw\application\index\view\index_footer.html";i:1546787432;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
                    ...
                    <form method="post">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" id="L_email" name="usermail" required lay-verify="required"
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="password" id="L_repass" name="confirm_password" required
...
<script>
    layui.use('form', function () {
        ...
        form.on('submit(login_reg)', function (data) {
            ...
            jq.post('<?php echo url("index/user/reg"); ?>', param, function (data) {
                if (data.code == 200) {
                    layer.close(loading);
                    layer.msg(data.msg, {icon: 1, time: 1000}, function () {
                        ...
                        jq.ajax({
                            ...
                            async: true,
                            dataType: 'json',
                            url: '<?php echo url("index/user/send_active_code"); ?>',
