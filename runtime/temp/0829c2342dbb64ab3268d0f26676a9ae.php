<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:60:"E:\phpStudy\WWW\kyw/application/admin\view\message_edit.html";i:1546769538;s:52:"E:\phpStudy\WWW\kyw\application\admin\view\base.html";i:1545906008;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <div class="layui-tab-brief">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <form class="layui-form form-container" data-url="<?php echo url('admin/message/update'); ?>"  localtion-url="<?php echo url('message/index'); ?>">
                   <div class="layui-form-item">
                        <label class="layui-form-label">系统公告</label>
                        <div class="layui-input-block">
                         <textarea name="content" placeholder="请输入系统公告" class="layui-textarea"><?php echo $slide_category['content']; ?></textarea>
