<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"E:\phpStudy\WWW\kyw/application/admin\view\system_changepwd.html";i:1546778940;s:52:"E:\phpStudy\WWW\kyw\application\admin\view\base.html";i:1548150336;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="layui-tab-brief">
    ...
    <div class="layui-tab-content">
        <div class="layui-tab-item layui-show">
            <form class="layui-form form-container" data-url="<?php echo url('admin/system/updatePassword'); ?>"
                  localtion-url="<?php echo url('admin/system/index'); ?>">
