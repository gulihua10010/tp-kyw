<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:60:"E:\phpStudy\WWW\kyw/application/index\view\index_message.html";i:1546790366;s:58:"E:\phpStudy\WWW\kyw\application\index\view\index_base.html";i:1546587990;s:60:"E:\phpStudy\WWW\kyw\application\index\view\index_header.html";i:1546789414;s:60:"E:\phpStudy\WWW\kyw\application\index\view\index_footer.html";i:1546787432;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<div class="fly-user-main">
    <ul class="layui-nav layui-nav-tree layui-inline user-set"  lay-filter="user"  >
        ...
        <li class="layui-nav-item  tab-this">
            <a href="<?php echo url('user/message'); ?> " style="color: white !important;">
                &nbsp;<i class="iconfont">&#xe61b;</i>
                系统公告
            </a>
        </li>
...
var n=1;
  ...
  <div class="fly-panel fly-panel-user  panel-user"  >
	  <div class="layui-tab layui-tab-brief" lay-filter="user" id="LAY_msg" style="margin-top: 15px;">
	    ...
	    <button class="layui-btn layui-btn-danger" id="LAY_delallmsg"  data-url="<?php echo url('user/delallmessage'); ?>" >清空全部消息</button>
       ...
       <?php else: ?>
           ...
           <?php if(is_array($tptc) || $tptc instanceof \think\Collection || $tptc instanceof \think\Paginator): $i = 0; $__LIST__ = $tptc;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($vo['type'] == 2): ?>
          <li class="messagelist">
            <blockquote class="layui-elem-quote">
              <a href="<?php echo url('user/home',array('id'=>$vo['userid'])); ?>" target="_blank"><cite><?php echo $vo['username']; ?></cite></a>回复了您的帖子<a target="_blank" href="<?php echo url('index/thread',array('id'=>$vo['content'])); ?>"><cite><?php echo getforumbyid($vo['content']); ?></cite></a>
            </blockquote>
            <p><span><?php echo friendlyDate($vo['time']); ?></span><a href="javascript:;" data-url="<?php echo url('user/delmessage',array('id'=>$vo['id'])); ?>" class=" elementdel layui-btn layui-btn-small layui-btn-danger fly-delete">删除</a></p>
          </li>
            <?php elseif($vo['type'] == 3): ?>
            <li class="messagelist">
            <blockquote class="layui-elem-quote">
              <a href="<?php echo url('user/home',array('id'=>$vo['userid'])); ?>" target="_blank"><cite><?php echo $vo['username']; ?></cite></a>回复了帖子<a target="_blank" href="<?php echo url('index/thread',array('id'=>$vo['content'])); ?>"><cite><?php echo getforumbyid($vo['content']); ?></cite></a>中你的评论
            </blockquote>
            <p><span><?php echo friendlyDate($vo['time']); ?></span><a href="javascript:;" data-url="<?php echo url('user/delmessage',array('id'=>$vo['id'])); ?>" class=" elementdel layui-btn layui-btn-small layui-btn-danger fly-delete">删除</a></p>
          </li>
          ...
          <?php else: ?>
           <li class="messagelist">
            ...
            <p><span><?php echo friendlyDate($vo['time']); ?></span><a href="javascript:;"   data-url="<?php echo url('user/delsysmessage',array('id'=>$vo['id'])); ?>" class=" elementdel layui-btn layui-btn-small layui-btn-danger fly-delete">删除</a></p>
          </li>
           <?php endif; endforeach; endif; else: echo "" ;endif; ?>
