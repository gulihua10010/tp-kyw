<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:57:"E:\phpStudy\WWW\kyw/application/admin\view\user_edit.html";i:1548931244;s:52:"E:\phpStudy\WWW\kyw\application\admin\view\base.html";i:1548150336;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <div class="layui-tab-brief">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <form class="layui-form form-container" data-url="<?php echo url('admin/user/update'); ?>"  localtion-url="<?php echo url('user/index'); ?>">
                    ...
                    <div class="layui-form-item">
                      ...
                      <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="number" name="point" value="<?php echo $user['point']; ?>" placeholder="（选填）请输入整数" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">邮箱</label>
                        <div class="layui-input-inline">
                            <input type="text" name="email" value="<?php echo $user['usermail']; ?>" required lay-verify="required"  placeholder="请输入邮箱" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            ...
                            <input type="radio" name="status" value="-1" title="禁用" <?php if($user['status'] <= 0): ?> checked="checked"<?php endif; ?>>
                            <input type="radio" name="status" value="2" title="禁言" <?php if($user['status'] == 2): ?> checked="checked"<?php endif; ?>>
                        </div>
                    </div>
