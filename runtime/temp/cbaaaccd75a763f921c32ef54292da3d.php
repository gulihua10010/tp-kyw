<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:59:"E:\phpStudy\WWW\kyw/application/admin\view\article_add.html";i:1548150622;s:52:"E:\phpStudy\WWW\kyw\application\admin\view\base.html";i:1548150336;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <div class="layui-tab-content">
        <div class="layui-tab-item layui-show">
            <form class="layui-form form-container"     id="layui-form"
                  localtion-url="<?php echo url('admin/article/index'); ?>">
                ...
                <div class="btable-paged">
                    <div class="layui-main">
                        <div class="formbtngroup">
                            <button class="layui-btn layui-btn-small" lay-submit="" lay-filter="formadd"  <?php if($infos ==  null): ?> disabled <?php endif; ?>>添加</button>
...
futext('#content');
        ...
        form.on('submit', function(data){
            ...
            ajaxform(formdata," <?php echo url('admin/article/save'); ?> ",$,function () {
