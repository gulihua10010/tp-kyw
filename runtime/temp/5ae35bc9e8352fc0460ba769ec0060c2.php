<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"E:\phpStudy\WWW\kyw/application/admin\view\index_adminindex.html";i:1548150622;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
	   ...
	   <link rel="shortcut icon" href="/kyw/public/images/favicon.ico">
		...
		<link rel="stylesheet" href="/kyw/public/css/global.css" media="all">
	...
	<body>
				...
				<div class="layui-main">
					<div class="admin-login-box">
						<a class="logo" style="left: 0;" >
							<span style="font-size: 30px;">考研网</span>
						</a>
					...
					<ul class="layui-nav admin-header-item">
						...
						<li class="layui-nav-item">
							<a href="<?php echo $root; ?>" target="_blank" >浏览网站</a>
						</li>
						
						<li class="layui-nav-item">
							<a href="javascript:;" class="admin-header-user">
								<img src="/kyw/public/images/default.png" />
								<span><?php echo session('admin_name'); ?></span>
							</a>
							<dl class="layui-nav-child">
								<dd>
									<a id="changemima" href="javascript:;"  data-url="<?php echo url('admin/system/diachange_password'); ?>"><i class="fa fa-user-circle" aria-hidden="true"></i> 修改密码</a>
								</dd>
								...
								<dd>
									<a class="logi_logout" href="javascript:void(0)"><i class="fa fa-sign-out" aria-hidden="true"></i> 注销</a>
								</dd>
							</dl>
						</li>
					</ul>
		...
		<div class="layui-side layui-bg-black" id="admin-side">
			...
			var lockurl="<?php echo url('login/locker'); ?>";
				...
				<script type="text/javascript" src="/kyw/public/js/index.js"></script>
