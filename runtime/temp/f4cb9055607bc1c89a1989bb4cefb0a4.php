<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"E:\phpStudy\WWW\kyw/application/admin\view\resource_type_edit.html";i:1548510174;s:52:"E:\phpStudy\WWW\kyw\application\admin\view\base.html";i:1548150336;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="layui-tab-brief">
    <div class="layui-tab-content">
        <div class="layui-tab-item layui-show">
            <form class="layui-form form-container" data-url="<?php echo url('admin/ResourceType/update'); ?>"
                ...
                <div class="layui-form-item" style="width: 300px;">
                    ...
                    <div class="layui-input-block">
                        <select name="pid" id="pid">
                            ...
                            <option value="<?php echo $vo['id']; ?>"  <?php if(($type['id'] == $vo['id']||$vo['ischild']||$vo['level'] > 1)==1): ?>disabled <?php endif; if($type['pid'] == $vo['id']): ?> selected<?php endif; ?>><?php if($vo['level'] != '1'): ?>|<?php for($i=1;$i<$vo['level'];$i++){echo ' --';} endif; ?><?php echo $vo['name']; ?>
                            </option>
