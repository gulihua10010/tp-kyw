<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"E:\phpStudy\WWW\kyw/application/admin\view\nav_footernav.html";i:1548150622;s:52:"E:\phpStudy\WWW\kyw\application\admin\view\base.html";i:1548150336;}*/ ?>
<!DOCTYPE html>
<html>
            ...
            <ul class="sortable">
                ...
                <li class="sorts">
                    ...
                    <ul class="sortable1">
                        ...
                        <li class="addbtn" data-id="<?php echo $nav_list['id']; ?>"><span style="display: none" class="typeid">4</span> <i class="layui-icon">&#xe608;</i></li>

                    </ul>

                </li>
                <?php endforeach; endif; else: echo "" ;endif; if($nav_count <= 9): ?>
                <li class="addbtn" data-id="0"><span style="display: none" class="typeid">4</span> <i class="layui-icon">&#xe608;</i></li>
                <?php endif; ?>
            </ul>
        </div>
    </div>
        ...
        jq('.dels').click(function () {
          var id= jq(this).parent().find('.navVal').text();
            layer.confirm('确定要删除嘛', {
                ...
                jq.get('<?php echo url("admin/nav/delete"); ?>?id='+id+'&type=4', function (data) {
                    if (data.code == 200) {
                        layer.close(loading);
...
// edits
        jq('.edits').click(function () {
            ...
            var index = layer.open({
                ...
                skin: 'layui-layer-rim', //加上边框
                area: ['820px', '500px'], //宽高
                content:  "<?php echo url('admin/nav/edit'); ?>?id="+id+"&type=4",
                end:function(){
                    location.reload();
                }
            })
