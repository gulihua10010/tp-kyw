<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:57:"E:\phpStudy\WWW\kyw/application/admin\view\magor_add.html";i:1548300192;s:52:"E:\phpStudy\WWW\kyw\application\admin\view\base.html";i:1548150336;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    layui.use(['layer', 'form', 'element', 'upload'], function () {
        ...
        form.on('submit', function (data) {
            ...
            if (text.trim() == ''  ){
                ...
                ajaxform(formdata, " <?php echo url('admin/magor/save'); ?> ", $, function () {
