<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"E:\phpStudy\WWW\kyw/application/admin\view\magor_subject_edit.html";i:1548213798;s:52:"E:\phpStudy\WWW\kyw\application\admin\view\base.html";i:1548150336;}*/ ?>
<!DOCTYPE html>
<html>
            ...
            <form method="post">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="name" required lay-verify="required" placeholder="必填内容" value="<?php echo $sub['name']; ?>"
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <textarea id="desc" name="desc" cols="50" rows="10"><?php echo $sub['desc']; ?></textarea>
                    </div>
                </div>
...
<script>
    layui.use(['layer', 'form', 'element', 'upload'], function () {
        ...
        form.on('submit', function (data) {
                ...
                ajaxform(formdata, " <?php echo url('admin/magorSubject/update'); ?> ", $, function () {
